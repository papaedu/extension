...
class GroupMsgGetSimpleRequest extends TimRequest
{
     ...
     * @return $this
     */
    public function setGroupId(string $groupId): GroupMsgGetSimpleRequest
    {
     ...
     * @return $this
     */
    public function setReqMsgNumber(int $reqMsgNumber): GroupMsgGetSimpleRequest
    {
     ...
     * @return $this
     */
    public function setReqMsgSeq(int $reqMsgSeq): GroupMsgGetSimpleRequest
    {
