...
class DeleteGroupMsgBySenderRequest extends TimRequest
{
     ...
     * @return $this
     */
    public function setGroupId(string $groupId): DeleteGroupMsgBySenderRequest
    {
     ...
     * @return $this
     */
    public function setSenderAccount(string $senderAccount): DeleteGroupMsgBySenderRequest
    {
