...
class DeleteGroupMemberRequest extends TimRequest
{
     ...
     * @return $this
     */
    public function setGroupId(string $groupId): DeleteGroupMemberRequest
    {
     ...
     * @return $this
     */
    public function setSilence(int $silence): DeleteGroupMemberRequest
    {
     ...
     * @return $this
     */
    public function setReason(string $reason): DeleteGroupMemberRequest
    {
