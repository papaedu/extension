...
class GetGroupInfoRequest extends TimRequest
{
     ...
     * @return $this
     */
    public function setGroupIdList(array $groupIdList): GetGroupInfoRequest
    {
     ...
     * @return $this
     */
    public function setResponseFilter(ResponseFilter $responseFilter): GetGroupInfoRequest
    {
