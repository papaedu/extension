...
class AccountImportRequest extends TimRequest
{
     ...
     * @return $this
     */
    public function setIdentifier(string $identifier): AccountImportRequest
    {
     ...
     * @return $this
     */
    public function setNick(string $nick): AccountImportRequest
    {
     ...
     * @return $this
     */
    public function setFaceUrl(string $faceUrl): AccountImportRequest
    {
