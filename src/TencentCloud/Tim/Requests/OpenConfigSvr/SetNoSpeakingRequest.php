...
class SetNoSpeakingRequest extends TimRequest
{
     ...
     * @return $this
     */
    public function setSetAccount(string $setAccount): SetNoSpeakingRequest
    {
     ...
     * @return $this
     */
    public function setC2CMsgSpeakingTime(int $c2CMsgSpeakingTime): SetNoSpeakingRequest
    {
     ...
     * @return $this
     */
    public function setGroupMsgNoSpeakingTime(int $groupMsgNoSpeakingTime): SetNoSpeakingRequest
    {
