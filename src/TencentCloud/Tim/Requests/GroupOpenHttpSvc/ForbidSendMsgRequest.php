...
class ForbidSendMsgRequest extends TimRequest
{
     ...
     * @return $this
     */
    public function setGroupId(string $groupId): ForbidSendMsgRequest
    {
     ...
     * @return $this
     */
    public function setMembersAccount(array $membersAccount): ForbidSendMsgRequest
    {
     ...
     * @return $this
     */
    public function setShutUpTime(int $shutUpTime): ForbidSendMsgRequest
    {
