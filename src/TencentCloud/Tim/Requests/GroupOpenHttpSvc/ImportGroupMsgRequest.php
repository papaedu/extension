...
class ImportGroupMsgRequest extends TimRequest
{
     ...
     * @return $this
     */
    public function setGroupId(string $groupId): ImportGroupMsgRequest
    {
     ...
     * @return $this
     */
    public function setMsgList(string $msgList): ImportGroupMsgRequest
    {
     ...
     * @return $this
     */
    public function setFromAccount(string $fromAccount): ImportGroupMsgRequest
    {
     ...
     * @return $this
     */
    public function setSendTime(int $sendTime): ImportGroupMsgRequest
    {
     ...
     * @return $this
     */
    public function setRandom(int $random): ImportGroupMsgRequest
    {
     ...
     * @return $this
     */
    public function setMsgBody(MsgBody $msgBody): ImportGroupMsgRequest
    {
