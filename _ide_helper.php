...
')
     ...
     */
         ...
         *
         *
         * @see \Papaedu\Extension\ServiceProvider::registerEnums()
         * @param mixed $removeNone
         * @static
         */
        public static function toEnumArray($removeNone = true)
        {
                        return \BenSampo\Enum\Enum::toEnumArray($removeNone);
        }
                    /**
         *
         *
         ...
         * @static
         */
        public static function toEnumValueArray($removeNone = true)
        {
                        return \BenSampo\Enum\Enum::toEnumValueArray($removeNone);
        }
                    /**
         *
         *
         ...
         * @static
         */
        public static function getKeyValue($enumValue)
        {
                        return \BenSampo\Enum\Enum::getKeyValue($enumValue);
        }
