...
class ImPushRequest extends TimRequest
{
     ...
     * @return $this
     */
    public function setMsgRandom(int $msgRandom): ImPushRequest
    {
     ...
     * @return $this
     */
    public function setMsgBody(MsgBody $msgBody): ImPushRequest
    {
     ...
     * @return $this
     */
    public function setMsfLifeTime(int $msgLifeTime): ImPushRequest
    {
     ...
     * @return $this
     */
    public function setFromAccount(string $fromAccount): ImPushRequest
    {
     ...
     * @return $this
     */
    public function setOfflinePushInfo(OfflinePushInfo $offlinePushInfo): ImPushRequest
    {
